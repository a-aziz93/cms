package core.crud.model.entity.expression.predicate.extension
...
fun Boolean.eq(value: core.crud.model.entity.expression.predicate.BooleanVariable) =
    this.v().eq(value)

fun Boolean.neq(value: core.crud.model.entity.expression.predicate.BooleanVariable) =
    this.v().neq(value)

fun Boolean.and(vararg values: core.crud.model.entity.expression.predicate.BooleanVariable) = this.v().and(*values)

fun Boolean.or(vararg values: core.crud.model.entity.expression.predicate.BooleanVariable) = this.v().or(*values)

fun Boolean.xor(vararg values: core.crud.model.entity.expression.predicate.BooleanVariable) = this.v().xor(*values)
...
fun Char.eq(value: core.crud.model.entity.expression.predicate.CharVariable) =
    this.v().eq(value)

fun Char.neq(value: core.crud.model.entity.expression.predicate.CharVariable) =
    this.v().neq(value)
...
fun Number.eq(value: core.crud.model.entity.expression.predicate.NumberVariable) =
    this.v().eq(value)

fun Number.neq(value: core.crud.model.entity.expression.predicate.NumberVariable) =
    this.v().neq(value)

fun Number.gt(value: core.crud.model.entity.expression.predicate.NumberVariable) =
    this.v().gt(value)

fun Number.gte(value: core.crud.model.entity.expression.predicate.NumberVariable) =
    this.v().gte(value)

fun Number.lt(value: core.crud.model.entity.expression.predicate.NumberVariable) =
    this.v().lt(value)

fun Number.lte(value: core.crud.model.entity.expression.predicate.NumberVariable) =
    this.v().lte(value)

fun Number.between(leftValue: core.crud.model.entity.expression.predicate.NumberVariable, rightValue: core.crud.model.entity.expression.predicate.NumberVariable) =
